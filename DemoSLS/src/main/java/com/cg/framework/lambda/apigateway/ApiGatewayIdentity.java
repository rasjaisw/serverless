...
/**
 * This class is used to hold all the property for request Identity.
 * 
 * @author anangupt
 *
 */
public class ApiGatewayIdentity implements Serializable{

	private static final long serialVersionUID = 2882220908215481495L;
